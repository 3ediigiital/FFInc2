...
.hero > div:not(.section-flakes){position:relative;z-index:1}
...
.hero h1{font-family:'Plus Jakarta Sans';font-size:60px;font-weight:800;line-height:1.05;letter-spacing:-2.1px;margin-bottom:22px}
...
.bcard.big{grid-row:auto;min-height:200px}
